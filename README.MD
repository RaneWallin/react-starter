...
You can start playing with this project immediately on [Gitch.com](https://glitch.com/~react-starter-no-frills). Just click the "Remix This" button below the preview.
